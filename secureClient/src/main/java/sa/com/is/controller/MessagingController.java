...
import sa.com.is.Account.Expunge;
import sa.com.is.AccountStats;
import sa.com.is.K9;
import sa.com.is.K9.NotificationHideSubject;
import sa.com.is.K9.Intents;
import sa.com.is.K9.NotificationQuickDelete;
import sa.com.is.NotificationSetting;
import sa.com.is.Preferences;

import sa.com.is.R;
import sa.com.is.activity.Accounts;
import sa.com.is.activity.FolderList;
import sa.com.is.activity.MessageList;
import sa.com.is.activity.MessageReference;
import sa.com.is.activity.NotificationDeleteConfirmation;
import sa.com.is.activity.setup.AccountSetupCheckSettings.CheckDirection;
import sa.com.is.activity.setup.AccountSetupIncoming;
import sa.com.is.activity.setup.AccountSetupOutgoing;
import sa.com.is.cache.EmailProviderCache;
import sa.com.is.helper.Contacts;
import sa.com.is.helper.MessageHelper;
import sa.com.is.power.TracingPowerManager;
import sa.com.is.power.TracingPowerManager.TracingWakeLock;
import sa.com.is.Address;
import sa.com.is.FetchProfile;
import sa.com.is.Flag;
import sa.com.is.Folder;
import sa.com.is.Folder.FolderType;

import sa.com.is.Message;
import sa.com.is.Message.RecipientType;
import sa.com.is.CertificateValidationException;
import sa.com.is.MessagingException;
import sa.com.is.Part;
import sa.com.is.PushReceiver;
import sa.com.is.Pusher;
...
import sa.com.is.mailstore.MessageRemovalListener;
import sa.com.is.MessageRetrievalListener;
import sa.com.is.mailstore.LocalFolder;
import sa.com.is.mailstore.LocalMessage;
import sa.com.is.mailstore.LocalStore;
import sa.com.is.mailstore.LocalStore.PendingCommand;
import sa.com.is.store.pop3.Pop3Store;
import sa.com.is.mailstore.UnavailableStorageException;
...
import sa.com.is.search.SearchAccount;
import sa.com.is.search.SearchSpecification;
import sa.com.is.search.SqlQueryBuilder;
import sa.com.is.service.NotificationActionService;
import sa.com.is.utils.transport.SecureTransport;
...
public class MessagingController implements Runnable {
    ...
    private static class NotificationData {
         ...
         * Don't modify this list directly, but use {@link #addMessage(sa.com.is.mailstore.LocalMessage)} and
         * {@link #removeMatchingMessage(android.content.Context, sa.com.is.activity.MessageReference)} instead.
         */
    ...
    public void sendPendingMessagesSynchronous(final Account account) {
        ...
        try {
            ...
            /*if(account.isSignedEmail())
                transport = new SecureTransport(context,account);*/
