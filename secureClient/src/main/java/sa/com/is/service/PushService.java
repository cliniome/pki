...
public class PushService extends CoreService {
    private static String START_SERVICE = "sa.com.is.service.PushService.startService";
    private static String STOP_SERVICE = "sa.com.is.service.PushService.stopService";
