...
import sa.com.is.activity.MessageCompose;
...
public class NotificationActionService extends CoreService {
    private final static String REPLY_ACTION = "sa.com.is.service.NotificationActionService.REPLY_ACTION";
    private final static String READ_ALL_ACTION = "sa.com.is.service.NotificationActionService.READ_ALL_ACTION";
    private final static String DELETE_ALL_ACTION = "sa.com.is.service.NotificationActionService.DELETE_ALL_ACTION";
    private final static String ARCHIVE_ALL_ACTION = "sa.com.is.service.NotificationActionService.ARCHIVE_ALL_ACTION";
    private final static String SPAM_ALL_ACTION = "sa.com.is.service.NotificationActionService.SPAM_ALL_ACTION";
    private final static String ACKNOWLEDGE_ACTION = "sa.com.is.service.NotificationActionService.ACKNOWLEDGE_ACTION";
     ...
     * @see #getArchiveAllMessagesIntent(android.content.Context, Account, java.io.Serializable)
     ...
     * (No confirmation on the phone required and moving these messages to the spam-folder possible)<br/>
     * Since we can not show a toast like on the phone screen, we must not offer actions that can not be performed.
     * @see #getSpamAllMessagesIntent(android.content.Context, Account, java.io.Serializable)
     * @param context the context to get a {@link MessagingController}
     * @param account the account (must allow moving messages to allow true as a result)
     * @param messages the messages to move to the spam folder (must be synchronized to allow true as a result)
