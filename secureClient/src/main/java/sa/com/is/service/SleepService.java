...
public class SleepService extends CoreService {
    ...
    private static String ALARM_FIRED = "sa.com.is.service.SleepService.ALARM_FIRED";
    private static String LATCH_ID = "sa.com.is.service.SleepService.LATCH_ID_EXTRA";
