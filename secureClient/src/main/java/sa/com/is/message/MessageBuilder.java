...
import sa.com.is.mailstore.TempFileBody;
import sa.com.is.mailstore.TempFileMessageBody;
...
public class MessageBuilder {
    ...
    public MessageBuilder setSigned(boolean signed)
    {
        this.signed = signed;
        return this;
    }

    public MessageBuilder setEncrypted(boolean encrypted)
    {
    ...
    private void buildBody(MimeMessage message) throws MessagingException {
        ...
        message.setSigned(this.signed);
        message.setEncrypted(this.encrypted);
    ...
    private TextBody buildText(boolean isDraft, SimpleMessageFormat simpleMessageFormat) {
        ...
        TextBodyBuilder textBodyBuilder = new TextBodyBuilder(messageText.trim());
